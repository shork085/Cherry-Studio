export enum IpcChannel {
  ...
  // Dataviz
  Dataviz_InitDb = 'dataviz:init-db',
  Dataviz_GetFormulas = 'dataviz:get-formulas',
  Dataviz_GetFormulaMaterials = 'dataviz:get-materials',
  Dataviz_GetFormulaStats = 'dataviz:get-stats',
  Dataviz_GetFormulaSolids = 'dataviz:get-solids',
  Dataviz_GetFormulaIdByType = 'dataviz:get-formula-id-by-type',
  Dataviz_GetMaterialVersion = 'dataviz:get-material-version',
  Dataviz_GetMaterialVersionByRowId = 'dataviz:get-version-by-row-id',
  Dataviz_UpdateTestQuality = 'dataviz:update-test-quality',
  Dataviz_UpdateMaterialCode = 'dataviz:update-material-code'
}
