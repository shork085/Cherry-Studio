...
import { BarChart3, Code, FileSearch, Folder, Languages, LayoutGrid, Palette, Sparkle } from 'lucide-react'
...
const LaunchpadPage: FC = () => {
  ...
  const appMenuItems = [
    ...
    {
      icon: <BarChart3 size={32} className="icon" />,
      text: t('title.dataviz'),
      path: '/dataviz',
      bgColor: 'linear-gradient(135deg,rgb(58, 165, 237),rgb(24, 168, 252))' // 数据可视化：紫色渐变，代表数据和分析
    }
  ]
