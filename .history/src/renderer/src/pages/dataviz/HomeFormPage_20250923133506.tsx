...
const LoadingSpinnerIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 50 50" width="18" height="18" style={{ position: 'absolute' }}>
    <circle cx="25" cy="25" r="20" stroke="currentColor" strokeWidth="4" fill="none" opacity="0.2" />
    <path d="M45 25a20 20 0 0 1-20 20" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" />
  </svg>
)
