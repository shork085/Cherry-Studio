...
const DataVizPage: React.FC = () => {
  ...
  const [ratioInput, setRatioInput] = React.useState<string>('1')
          ...
          <Route
            ...
            element={
              <HomeFormPage
                ...
                stoichRatio={Number.isFinite(parseFloat(ratioInput)) ? parseFloat(ratioInput) : 1}
              />
            }
          />
