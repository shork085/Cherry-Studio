      ...
      <FormContent>
        ...
        <BottomForm>
          ...
          <div className="BtnCont">
            <TopButton onClick={() => console.log('顶部按钮点击')}>顶部按钮</TopButton>
            <IconWrapper>
              <ExportIcon />
            </IconWrapper>
          </div>
...
const ImportIcon = () => (
  <svg viewBox="0 0 1024 1024" width="24" height="24">
    <path d="M134.4 919.3c7.6 0 15.2-2.9 21-8.7L622.2 443.9c11.6-11.6 11.6-30.4 0-42-5.8-5.8-13.4-8.7-21-8.7s-15.2 2.9-21 8.7L113.5 868.6c-11.6 11.6-11.6 30.4 0 42 5.7 5.8 13.3 8.7 20.9 8.7z"></path>
    <path d="M155.4 155.4h713.1v713.1H601.1c-7.6 0-15.2 2.9-21 8.7-5.8 5.8-8.7 13.4-8.7 21s2.9 15.2 8.7 21c5.8 5.8 13.4 8.7 21 8.7h267.5c32.8 0 59.4-26.6 59.4-59.4V155.4c0-32.8-26.6-59.4-59.4-59.4H422.9c-7.6 0-15.2 2.9-21 8.7-5.8 5.8-8.7 13.4-8.7 21s2.9 15.2 8.7 21c5.8 5.8 13.4 8.7 21 8.7h267.5v208c0 7.6-2.9 15.2-8.7 21-5.8 5.8-13.4 8.7-21 8.7s-15.2-2.9-21-8.7c-5.8-5.8-8.7-13.4-8.7-21v-208H155.4c-32.8 0-59.4 26.6-59.4 59.4v208c0 7.6 2.9 15.2 8.7 21 5.8 5.8 13.4 8.7 21 8.7s15.2-2.9 21-8.7c5.8-5.8 8.7-13.4 8.7-21v-208c0-32.8 26.6-59.4 59.4-59.4z"></path>
  </svg>
)
