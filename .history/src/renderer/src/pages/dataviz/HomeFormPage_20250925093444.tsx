        ...
        rows: [
          {
            label: 'reactive',
            values: [
              computedStats?.binderView.reactive_base || '-',
              computedStats?.binderView.reactive_hardener || '-',
              computedStats?.binderView.reactive_set || '-'
            ]
          },
          {
            label: 'nonreactive',
    ...
    },
    {
      ...
      ratioData: {
        ...
        rows: [
          {
            label: 'reactive',
            value: computedStats?.reactivity?.MIX?.reactive_pct || '-',
            unit: '%'
          },
          {
            label: 'non reactive',
            value: computedStats?.reactivity?.MIX?.nonreactive_pct || '-',
            unit: '%'
          }
        ]
      }
