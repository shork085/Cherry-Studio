        ...
        rows: [
          {
            label: 'reactive',
            values: [
              Number(computedStats?.binderView.reactive_base).toFixed(2),
              Number(computedStats?.binderView.reactive_hardener).toFixed(2),
              Number(computedStats?.binderView.reactive_set).toFixed(2)
            ]
          },
          {
            label: 'nonreactive',
            values: [
              Number(computedStats?.binderView.non_react_base).toFixed(2),
              Number(computedStats?.binderView.non_react_hardener).toFixed(2),
              Number(computedStats?.binderView.non_react_set).toFixed(2)
            ]
          },
          {
            label: 'total binder',
            values: [
              Number(computedStats?.binderView.total_base).toFixed(2),
              Number(computedStats?.binderView.total_hardener).toFixed(2),
              Number(computedStats?.binderView.total_set).toFixed(2)
            ]
          }
        ]
      }
