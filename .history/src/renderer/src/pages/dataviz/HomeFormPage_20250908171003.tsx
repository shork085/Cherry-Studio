        ...
        <BottomForm>
          <BottomFormItem>
            ...
            <FormInfo>
              ...
              <p title={String(formStat[0]?.a_density ?? '-')}>{formStat[0]?.a_density ?? '-'}</p>
              <p title="g/cm3">g/cm3</p>
            </FormInfo>
            <FormInfo>
              <div title="组分B的比重">组分B的比重</div>
              <p title={String(formStat[0]?.b_density ?? '-')}>{formStat[0]?.b_density ?? '-'}</p>
              <p title="g/cm3">g/cm3</p>
            </FormInfo>
            <FormInfo>
              <div title="混合物的比重">混合物的比重</div>
              <p title={String(formStat[0]?.mix_density ?? '-')}>{formStat[0]?.mix_density ?? '-'}</p>
              <p title="g/cm3">g/cm3</p>
            </FormInfo>
          </BottomFormItem>
          ...
          <BottomFormItem>
            ...
            <FormInfo $small>
              ...
              <p title={String(formStat[0]?.a_mass_ratio ?? '-')}>{formStat[0]?.a_mass_ratio ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="组分B的质量比">组分B的质量比</div>
              <p title={String(formStat[0]?.b_mass_ratio ?? '-')}>{formStat[0]?.b_mass_ratio ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="组分A的体积比">组分A的体积比</div>
              <p title={String(formStat[0]?.a_volume_ratio ?? '-')}>{formStat[0]?.a_volume_ratio ?? '-'}</p>
              <p title="v%">v%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="组分B的体积比">组分B的体积比</div>
              <p title={String(formStat[0]?.b_volume_ratio ?? '-')}>{formStat[0]?.b_volume_ratio ?? '-'}</p>
              <p title="v%">v%</p>
            </FormInfo>
          </BottomFormItem>
          ...
          <BottomFormItem>
            ...
            <FormInfo>
              ...
              <p title={String(formStat[0]?.a_price ?? '-')}>{formStat[0]?.a_price ?? '-'}</p>
              <p title="RMB/kg">RMB/kg</p>
            </FormInfo>
            <FormInfo>
              <div title="组分B的价格">组分B的价格</div>
              <p title={String(formStat[0]?.b_price ?? '-')}>{formStat[0]?.b_price ?? '-'}</p>
              <p title="RMB/kg">RMB/kg</p>
            </FormInfo>
            <FormInfo>
              <div title="配方的价格">配方的价格</div>
              <p title={String(formStat[0]?.mix_price ?? '-')}>{formStat[0]?.mix_price ?? '-'}</p>
              <p title="RMB/kg">RMB/kg</p>
            </FormInfo>
          </BottomFormItem>
          ...
          <BottomFormItem className="smallForm">
            ...
            <FormInfo $small>
              ...
              <p title={String(formSolidA[0]?.mass_solid ?? '-')}>{formSolidA[0]?.mass_solid ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="体积固含(v%)">体积固含(v%)</div>
              <p title={String(formSolidA[0]?.volume_solid ?? '-')}>{formSolidA[0]?.volume_solid ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="组分A的体积比">组分A的体积比</div>
          ...
          <BottomFormItem className="smallForm">
            ...
            <FormInfo $small>
              <div title="质量固含(wt%)">质量固含(wt%)</div>
              <p title={String(formSolidB[0]?.mass_solid ?? '-')}>{formSolidB[0]?.mass_solid ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="体积固含(v%)">体积固含(v%)</div>
              <p title={String(formSolidB[0]?.volume_solid ?? '-')}>{formSolidB[0]?.volume_solid ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="组分B的体积比">组分B的体积比</div>
          ...
          <BottomFormItem className="smallForm">
            ...
            <FormInfo $small>
              <div title="质量固含(wt%)">质量固含(wt%)</div>
              <p title={String(formSolidMix[0]?.mass_solid ?? '-')}>{formSolidMix[0]?.mass_solid ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="体积固含(v%)">体积固含(v%)</div>
              <p title={String(formSolidMix[0]?.volume_solid ?? '-')}>{formSolidMix[0]?.volume_solid ?? '-'}</p>
              <p title="wt%">wt%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="混合体的体积比">混合体的体积比</div>
              <p title={String(formStat[0]?.mix_volume_ratio ?? '-')}>{formStat[0]?.mix_volume_ratio ?? '-'}</p>
              <p title="v%">v%</p>
            </FormInfo>
            <FormInfo $small>
              <div title="PVC">PVC</div>
