      ...
      reactiveData: {
        ...
        rows: [
          ...
          },
          {
            label: 'nonreactive',
            values: [
              computedStats?.reactivity.A.nonreactive_binder_wt_set,
              computedStats?.reactivity.B.nonreactive_binder_wt_set,
              computedStats?.reactivity.MIX.nonreactive_binder_wt_set
            ]
          },
          {
            label: 'total binder',
