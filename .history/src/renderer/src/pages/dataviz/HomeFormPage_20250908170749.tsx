              ...
              <FormTable>
                ...
                <tbody>
                  {formDataA.map((item, index) => (
                    <tr key={index}>
                      <td title={String(item.material_code ?? '')}>{item.material_code}</td>
                      <td title={String(item.material_desc ?? '')}>{item.material_desc}</td>
                      <td title={String(item.test_quality ?? '')}>{item.test_quality}</td>
                      <td title={String(item.quality_score ?? '')}>{item.quality_score}</td>
                      <td title={String(item.mix ?? '')}>{item.mix}</td>
                      <td title={String(item.price ?? '')}>￥{item.price}</td>
                    </tr>
                  ))}
                </tbody>
              </FormTable>
