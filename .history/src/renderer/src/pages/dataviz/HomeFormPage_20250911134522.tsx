...
import FormTableComponent, { TableColumn, TableDataItem } from './components/FormTableComponent'
...
const HomeFormPage: React.FC = () => {
  ...
  // 表格数据配置
  const tableData = [
    { title: '组分A', data: formDataA as TableDataItem[] },
    { title: '组分B', data: formDataB as TableDataItem[] }
  ]
