                ...
                <tbody>
                  {formDataA.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        {typeof item.test_quality === 'number' ? item.test_quality.toFixed(2) : item.test_quality}
                      </td>
                      <td>
                        {typeof item.quality_score === 'number' ? item.quality_score.toFixed(2) : item.quality_score}
                      </td>
