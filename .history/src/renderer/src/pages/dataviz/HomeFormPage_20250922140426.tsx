  ...
  return (
    <FormContainer>
      ...
      <FormContent>
        ...
        {/* 悬浮选择菜单 */}
        {showSelectMenu && (
          <SelectMenuOverlay onClick={handleOutsideClick}>
            <SelectMenu $isAnimating={isMenuAnimating} onClick={handleMenuClick}>
              <SelectMenuItem onClick={() => console.log('选项1')}>选项1</SelectMenuItem>
              <SelectMenuItem onClick={() => console.log('选项2')}>选项2</SelectMenuItem>
              <SelectMenuItem onClick={() => console.log('选项3')}>选项3</SelectMenuItem>
            </SelectMenu>
          </SelectMenuOverlay>
        )}
      </FormContent>
...
const SelectMenu = styled.div<{ $isAnimating: boolean }>`
  ...
  min-width: 120px;
  z-index: 1001;
  // transform: ${(props) => (props.$isAnimating ? 'scale(1) translateY(0)' : 'scale(0.8) translateY(-10px)')};
