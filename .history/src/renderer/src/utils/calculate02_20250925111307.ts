...
export function computeFormStats(
  ...
  */
  ...
  return {
    ...
    reactivity: {
      A: {
        reactive_binder_wt_set: round(reactive_binder_wt_set_A, 2),
        non_reactive_binder_wt_set: round(non_reactive_binder_wt_set_A, 2)
      },
      B: {
        reactive_binder_wt_set: round(reactive_binder_wt_set_B, 2),
        non_reactive_binder_wt_set: round(non_reactive_binder_wt_set_B, 2)
      },
      MIX: {
        reactive_binder_wt_set: round(reactive_binder_wt_set, 2),
        non_reactive_binder_wt_set: round(non_reactive_binder_wt_set, 2),
        total_binder_wt_set: round(total_binder_wt_set, 2),
