...
// Form materials for HomeFormPage
...
export const db = new Dexie('CherryStudio', {
  ...
  form_materials: EntityTable<FormMaterial, 'id'>
}
...
// Version 10: add form_materials for HomeFormPage
db.version(10).stores({
  ...
  form_materials: '&id, component, order'
})
