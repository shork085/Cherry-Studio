    ...
    <div
      ...
      <input
        ...
        style={{
          ...
          background: error ? '#fff7f7' : '#ffffff',
          borderRadius: 4,
          transition: 'border-color 160ms ease, background-color 160ms ease, box-shadow 160ms ease',
          boxShadow: error ? '0 0 0 2px rgba(211,47,47,0.08)' : '0 0 0 2px rgba(74,144,226,0.06)'
        }}
        disabled={false}
      />
      ...
      <div
        style={{
          ...
          left: 0,
          right: 0,
          transform: error ? 'translateY(-10px)' : 'translateY(-6px)',
          opacity: error ? 1 : 0,
