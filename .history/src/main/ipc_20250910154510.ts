...
export function registerIpc(mainWindow: BrowserWindow, app: Electron.App) {
  ...
  ipcMain.handle(IpcChannel.Dataviz_GetQualityScore, async (_event, formulaId: number, groupType: string) => {
    return await mySQLService.calculateQualityScore(formulaId, groupType)
  })
}
