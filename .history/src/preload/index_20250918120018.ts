...
const api = {
  ...
  dataviz: {
    ...
    }) => ipcRenderer.invoke(IpcChannel.Dataviz_InitDb, config),
    getFormulas: () => ipcRenderer.invoke(IpcChannel.Dataviz_GetFormulas),
    getFormulaMaterials: (formulaId: number) => ipcRenderer.invoke(IpcChannel.Dataviz_GetFormulaMaterials, formulaId),
    getFormulaStats: (formulaId: number) => ipcRenderer.invoke(IpcChannel.Dataviz_GetFormulaStats, formulaId),
    getFormulaSolids: (formulaId: number) => ipcRenderer.invoke(IpcChannel.Dataviz_GetFormulaSolids, formulaId),
    getFormulaIdByType: (formulaName: string) => ipcRenderer.invoke(IpcChannel.Dataviz_GetFormulaIdByType, formulaName),
    getMaterialVersion: (formulaId: number, materialId: number, groupType: string) =>
      ipcRenderer.invoke(IpcChannel.Dataviz_GetMaterialVersion, formulaId, materialId, groupType),
    getMaterialVersionByRowId: (id: number) => ipcRenderer.invoke(IpcChannel.Dataviz_GetMaterialVersionByRowId, id),
    updateMaterialTestQuality: (
      id: number,
      // materialId: number,
      // groupType: string,
