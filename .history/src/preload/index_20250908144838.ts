...
const api = {
  ...
  mysql: {
    setConfig: (config: any) => ipcRenderer.invoke(IpcChannel.Mysql_SetConfig, config),
    queryForm: (params: { tableA: string; tableB: string }) => ipcRenderer.invoke(IpcChannel.Mysql_QueryForm, params)
  }
}
